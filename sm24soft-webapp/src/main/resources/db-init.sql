...
CREATE TABLE `item_detail` (
  ...
  `void_item_flg` varchar(1) NOT NULL DEFAULT '0',
  `invoice_number` int(8) unsigned zerofill NOT NULL,
  `delete_flg` varchar(1) NOT NULL DEFAULT '0',
  `created_at` datetime NOT NULL,
  `created_user_id` int(8) unsigned zerofill NOT NULL,
...
INSERT INTO `menu` VALUES (01,'Rau sach',0,0,'ASC','rau-sach-dang-hang',1,'0','2016-07-09 15:58:44',00000000,'2016-07-10 01:44:18',00000000);
...
CREATE TABLE `supplier` (
  ...
  `fax_number2` varchar(15) DEFAULT NULL,
  `fax_number3` varchar(15) DEFAULT NULL,
  `loyalty_accumulated_point` int(8) DEFAULT '0',
...
INSERT INTO `supplier` VALUES (0002,'Trang trai Ga','Trang trai Ga',NULL,NULL,'Vinh Phuc',NULL,'trangtraiga@gmail.com','12345',NULL,NULL,NULL,NULL,NULL,0,'','1','2016-07-11 00:15:28',00000000,'2016-07-11 01:00:53',00000000);
...
CREATE TABLE `supplier_image` (
  ...
  `kind_of_image` varchar(30) NOT NULL,
  `supplier_email_address` varchar(60) NOT NULL,
  `delete_flg` varchar(1) NOT NULL DEFAULT '0',
...
--
-- Dumping events for database 'sm24soft_v1'
--

--
-- Dumping routines for database 'sm24soft_v1'
--
...
-- Dump completed on 2016-07-11 22:40:10
