...
public class NonUniqueObjectException extends Exception {
	 ...
	 */
	public NonUniqueObjectException(final String message) {
		super(message);
	}
	 ...
	 * @since 1.4
	 */
	public NonUniqueObjectException(final Throwable cause) {
		super(cause);
	}
	 ...
	 * @since 1.4
	 */
	public NonUniqueObjectException(final String message, final Throwable cause) {
		super(message, cause);
	}
